<div class="relative isolate px-6 pt-14 lg:px-8 relative z-10">
	<div class="container mx-auto">
		...
		<section class="w-full max-w-screen-xl px-4 mx-auto lg:px-12 mb-4">
			<a href="<?php APP_URL; ?>/create-website" class="flex flex-col items-center py-6 bg-gray-800/25 backdrop-blur-md rounded-lg shadow md:flex-row hover:backdrop-blur-xl">
