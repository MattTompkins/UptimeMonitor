...
use UptimeMonitor\Controllers\MonitorController;
...
$router->get('/site/(\d+)/create-monitor', function ($queryParams, $routeParams) { MonitorController::createMonitor( $routeParams[0] ); } );
$router->post('/site/(\d+)/create-monitor', function ($queryParams, $routeParams) { MonitorController::storeMonitor( $routeParams[0] );  });
